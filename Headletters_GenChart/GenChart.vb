...
Public Class GenChart
    Public Shared Sub Main()
        ...
        Try
            ...
            da.Fill(RowsData)
            UID = RowsData.Tables(0).Rows(0)(0).Trim.ToString()
            HID = RowsData.Tables(0).Rows(0)(1).Trim.ToString()
...
#End Region
        ...
        Catch ex As Exception
            Dim strFile As String = String.Format("C:\inetpub\wwwroot\ServiceLogs\ErrorLog_{1}_{0}.txt", HID + UID, DateTime.Today.ToString("dd-MMM-yyyy"))
